class ShaderScene extends CGFscene {
    ...
    // water stuff
		this.water_appearance = new CGFappearance(this);
		this.watertex = new CGFtexture(this, "textures/waterTex.jpg");
    this.water_appearance.setTexture(this.watertex);
		this.water_appearance.setTextureWrap('REPEAT', 'REPEAT');
		this.watermap = new CGFtexture(this, "textures/waterMap.jpg");
    this.wateranim_cnt = 0;
		...
		this.testShaders = [
			...
			new CGFshader(this.gl, "shaders/texture1.vert", "shaders/new_sepia.frag"),
    ...
    // watermap REPEAT mode
    var short = this.watermap.gl;
    short.texParameteri(short.TEXTURE_2D, short.TEXTURE_WRAP_T, short.REPEAT);
    short.texParameteri(short.TEXTURE_2D, short.TEXTURE_WRAP_S, short.REPEAT);
