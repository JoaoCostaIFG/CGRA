...
class MyScene extends CGFscene {
  ...
  init(application) {
    ...
    this.globalAmbientLightFactor = 0.3;
  }
  initLights() {
  ...
  initMaterials() {
    ...
    this.material4.setAmbient(0.68, 0.49, 0.29, 1.0);
    this.material4.setDiffuse(0.68, 0.49, 0.29, 1.0);
